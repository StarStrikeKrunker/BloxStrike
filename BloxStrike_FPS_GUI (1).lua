...
local function ShowIntro()
    ...
    SubLabel.Text = "Tactical Superiority"
    ...
    VersionLabel.BackgroundTransparency = 1
    VersionLabel.Position = UDim2.new(0.5, 0, 0.6, 0)
    ...
    LoadingLabel.TextColor3 = Color3.fromRGB(100, 200, 255)
    ...
    wait(0.3)
    TweenService:Create(VersionLabel, TweenInfo.new(1, Enum.EasingStyle.Quad), {TextTransparency = 0}):Play()
    wait(0.3)
    TweenService:Create(LoadingLabel, TweenInfo.new(1, Enum.EasingStyle.Quad), {TextTransparency = 0}):Play()
    ...
    TweenService:Create(VersionLabel, TweenInfo.new(0.5, Enum.EasingStyle.Quad), {TextTransparency = 1}):Play()
    TweenService:Create(LoadingLabel, TweenInfo.new(0.5, Enum.EasingStyle.Quad), {TextTransparency = 1}):Play()
...
local function ShowKeySystem()
    ...
    KeyBorder.BackgroundColor3 = Color3.fromRGB(100, 200, 255)
    KeyBorder.BorderSizePixel = 0
    KeyBorder.Size = UDim2.new(1, 4, 1, 4)
    KeyBorder.Position = UDim2.new(0, -2, 0, -2)
    KeyBorder.ZIndex = 0
    ...
    KeyDesc.Position = UDim2.new(0, 0, 0, 70)
    KeyDesc.Size = UDim2.new(1, 0, 0, 40)
    KeyDesc.Font = Enum.Font.Gotham
    KeyDesc.Text = "Enter your key to continue"
    KeyDesc.TextColor3 = Color3.fromRGB(150, 150, 160)
    KeyDesc.TextSize = 14
    ...
    SkipBtn.Parent = KeyFrame
    SkipBtn.BackgroundColor3 = Color3.fromRGB(52, 152, 219)
    SkipBtn.Position = UDim2.new(0, 210, 0, 190)
    SkipBtn.Size = UDim2.new(0, 140, 0, 40)
    SkipBtn.Font = Enum.Font.GothamBold
    SkipBtn.Text = "⚡ Skip (Free)"
    ...
    local validKey = "BLOXSTRIKE2026"
    local keyValid = false
    
    SubmitBtn.MouseButton1Click:Connect(function()
        if KeyInput.Text == validKey then
            StatusLabel.Text = "✓ Key valid! Loading GUI..."
    ...
    SkipBtn.MouseButton1Click:Connect(function()
        StatusLabel.Text = "⚡ Skipping key check..."
    ...
    -- Wait for key validation or skip
    repeat wait() until not KeyGui.Parent or keyValid
