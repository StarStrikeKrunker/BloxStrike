...
-- FIXED: Property order - Parent must be set before other properties!
...
local function ShowKeySystem()
    ...
    InfoLabel.Text = "Made by I Went Kimbo | v2.0"
...
local function ShowIntro()
    ...
    SubtitleLabel.Text = "ESP & Combat Script v2.0"
...
local function CreateGUI()
    ...
    if game.CoreGui:FindFirstChild("BloxStrikeUniversalFarm") then
        game.CoreGui:FindFirstChild("BloxStrikeUniversalFarm"):Destroy()
    end
    ...
    Version.Text = "v2.0 | Made by I Went Kimbo"
